...
public class OrderController {
	 ...
	 * @param Order
	 * @return 包含status和data的对象, TaotaoResult
	 * 注意:在提交订单前,需要查询当前登录用户信息,添加到订单的属性中
	 */
	@PostMapping("submit")
	@ResponseBody
public TaotaoResult submitOrder(Order order,@CookieValue(LoginInterceptor.COOKIE_NAME)String token){
		//获取当前用户信息
