...
<script type="text/javascript" src="${staticPath}/js/jquery-extend.js"></script>
<script type="text/javascript" src="${staticPath}/js/lib-v1.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticPath}/js/taotao.js" charset="utf-8"></script>
