...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link href="${staticPath}/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.taotao.com/"><img clstag="clickcart|keycount|xincart|logo" src="${staticPath}/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
...
<script type="text/javascript" src="${staticPath}/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="../commons/footer.jsp" />
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="${staticPath}/js/cart.js"></script>
<script type="text/javascript" src="${staticPath}/js/jquery.price_format.2.0.min.js"></script>
